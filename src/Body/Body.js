            ...
            <ResponsiveContainer width="100%" height={400}>
                <LineChart data={data}>
                    ...
                    {xHigh.length ? xHigh.map(x => (
                        <ReferenceArea key={x1} x1={x.i + 10} x2={x.i + 10 + 1} stroke="red" fill="red" strokeOpacity={0.3} fillOpacity={0.2} />
                    )) :

                        (
                            <ReferenceArea x1={x1 + 10} x2={x1 + hourRange + 10} stroke="green" fill="green" strokeOpacity={0.3} fillOpacity={0.2} />
                        )}
                </LineChart>
            </ResponsiveContainer>
